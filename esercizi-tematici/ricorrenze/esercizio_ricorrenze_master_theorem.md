...
Potremmo essere nel Caso 3. Verifichiamo la prima condizione, ovvero se $\exists \varepsilon > 0$ tale che 
...
**Prima condizione:** In modo analogo alla ricorrenza (4), si trova che una scelta di $\varepsilon$ (ad esempio $\varepsilon = 1$) soddisfa ampiamente la condizione $f(n) = \Omega(n^{\log_b a + \varepsilon})$
